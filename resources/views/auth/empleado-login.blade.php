                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('empleado.login') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="contrasena" type="password" class="form-control @error('contrasena') is-invalid @enderror" name="contrasena" required autocomplete="current-cotrasena">
                        ...
                        <div class="row mb-0">
                            <div class="col-md-8 offset-md-4">
                                ...
                                @if (Route::has('empleado.password.request'))
                                    <a class="btn btn-link" href="{{ route('empleado.password.request') }}">
