                ...
                <div class="card-body">
                  ...
                  @csrf
                    ...
                    <div align="center" class="information-box round" style="font-size:14px;">
                      ...
                      <a href="terminos.php?variable1=4273404" style="color:#F00;" onclick="MM_openBrWindow('terminos.php','TerminosCondiciones','toolbar=yes,location=yes,status=yes,menubar=yes,scrollbars=yes,resizable=yes')">
